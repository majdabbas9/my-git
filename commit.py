...
from help import change_head,find_parent_commit,extract_tree_oid_from_commit_head
...
def my_get_commit(message,to_ignore,author_name = "You",author_email = "you@example.com",curr_branch = "main"):
